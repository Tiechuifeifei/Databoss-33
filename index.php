...
<main>
  ...
  <section class="hero-banner">
    ...
    <a href="browse.php" class="btn btn-lg mt-3 btn-explore">
      Explore More
    </a>
    </div>
  </section>
  ...
  <section class="section section-products py-5">
    <div class="container">
      ...
      <div class="d-flex justify-content-between align-items-baseline mb-4 section-header">
        <h2 class="mb-0" style="font-family: monospace,'Monaco';">Recommendations</h2>
      </div>

    <!--This is auction recommendations-->
    <div class="row auction-grid no-gutters">
        <?php if ($result && $result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            <div class="col-12 col-sm-6 col-md-3 mb-5">
              
            <article class="card item_card h-100 border-0">
          ...
          <!--text-->
                <div class="card-body">
                  ...
                  <p class="item-info">Auction Ends:
                    <?=htmlspecialchars($row['auctionEndTime'])?>
                  </p>
                  <p class="item-info">Start Price:£
          ...
          <?php endwhile; ?>
        <?php else: ?>
          <p class="item-info mb-1">No active auctions at the moment.</p>
        <?php endif; ?>
      </div>
    </div>
  </section>
